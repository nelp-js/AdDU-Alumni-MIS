...
const MODULE_CARDS = [
    ...
    { icon: 'briefcase',   title: 'Job & Internship',        description: 'Job postings, applications, and career tracking',                                  button: 'Manage Jobs & Interships',      to: '#',                   secondaryButton: 'Create Job or Intership',        secondaryTo: '/dashboard/jobs/create' },
