...
function CreateJob() {
    ...
    const [formData, setFormData] = useState(() => {
        if (routeType === 'internship') return { ...INTERNSHIP_FIELDS };
        return { ...JOB_FIELDS };
    });
    ...
    useEffect(() => {
        ...
        if (type === 'job') {
            setFormData({ ...JOB_FIELDS });
        } else if (type === 'internship') {
            setFormData({ ...INTERNSHIP_FIELDS });
        }
    }, [type, isEditMode]);
                ...
                <div className="create-event-form-box">
                    ...
                    {!loadingInitial && !loadError && (
                        <form className="create-event-form" onSubmit={handleSubmit}>
                            {submitError && (
                                <div className="jm-state jm-error" style={{ padding: '8px 0 4px', textAlign: 'left' }}>
                                    {submitError}
                                </div>
                            )}
                            ...
                            <div className="ce-row">
                                <div className="ce-field-group ce-field-half">
                                    <div className="ce-label-row">
                                        <label className="ce-label-large">
                                            Company Name <span className="ce-required">*</span>
                                        </label>
                                    ...
                                    <input
                                        ...
                                        placeholder="e.g. Ateneo de Davao University"
                                        required
                                    />
                                </div>
                                ...
                                <div className="ce-field-group ce-field-half">
                                    <div className="ce-label-row">
                                        <label className="ce-label-large">
                                            Position Title <span className="ce-required">*</span>
                                        </label>
                                    ...
                                    <input
                                        ...
                                        className="ce-input"
                                        maxLength={MAX_TEXT_60}
                                        placeholder={type === 'job' ? 'e.g. Senior Software Engineer' : 'e.g. UI/UX Intern'}
                                        required
                                    />
                                </div>
                            </div>
                            ...
                            <div className="ce-row">
                                <div className="ce-field-group ce-field-half">
                                    <div className="ce-label-row">
                                        <label className="ce-label-large">
                                            Location <span className="ce-required">*</span>
                                        </label>
                                ...
                                <div className="ce-field-group ce-field-half">
                                    <label className="ce-label-large">
                                        Work Modality <span className="ce-required">*</span>
                                    </label>
                                    <select
                                        name="modality"
                            ...
                            {type === 'job' && (
                                <div className="ce-row">
                                    <div className="ce-field-group ce-field-half">
                                        <label className="ce-label-large">
                                            Employment Type <span className="ce-required">*</span>
                                        </label>
                                        <select
                                            name="employmentType"
                            ...
                            <div className="ce-row">
                                <div className="ce-field-group ce-field-half">
                                    <div className="ce-label-row">
                                        <label className="ce-label-large">
                                            Contact Name <span className="ce-required">*</span>
                                        </label>
                                ...
                                <div className="ce-field-group ce-field-half">
                                    <div className="ce-label-row">
                                        <label className="ce-label-large">
                                            Company Position <span className="ce-required">*</span>
                                        </label>
                            ...
                            <div className="ce-field-group">
                                <div className="ce-label-row">
                                    <label className="ce-label-large">
                                        Contact Email <span className="ce-required">*</span>
                                    </label>
