...
import CampaignContributors from "./pages/CampaignContributors"
  ...
  return (
    ...
    <BrowserRouter>
      ...
      <Routes>
        ...
        <Route path="/dashboard/campaigns/contributors" element={<AdminProtectedRoute><CampaignContributors /></AdminProtectedRoute>} />
